...
let typeMap: {[index: string]: any} = {
    ...
    "CheckGuessResponse": CheckGuessResponse,
    "ErrorResponse": ErrorResponse,
    "Guess": Guess,
    "GuessCategoryResult": GuessCategoryResult,
    "Player": Player,
    "PreviousPlayerResponse": PreviousPlayerResponse,
    "ResetTimeResponse": ResetTimeResponse,
}
