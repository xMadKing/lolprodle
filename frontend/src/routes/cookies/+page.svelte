    ...
    <div class="card w-4/5 bg-base-300 shadow-xl">
        <div class="card-body">
            ...
            <p>
                ...
                collect using Cookies and how that information is used. This Cookies Policy has been
                created with the help of the <a
                    href="https://www.privacypolicies.com/cookies-policy-generator/"
                    target="_blank">Cookies Policy Generator</a
                >
            ...
            <h1 class="text-xl font-bold">Interpretation and Definitions</h1>
            ...
            <ul class="list-disc list-inside">
                <li>
                    ...
                    &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to lolprodle.
                </li>
                <li>
                ...
                <li>
                    <strong>Website</strong> refers to lolprodle, accessible from
                    <a
                        href="http://lolprodle.com"
                ...
                <li>
                    ...
                    or any legal entity on behalf of which such individual is accessing or using the
            ...
            <ul class="list-disc list-inside">
                <li>
                    ...
                    <p>
                        ...
                        to keep track of game data. Without these Cookies, core features of the
                        website cannot be provided, and We only use these Cookies to provide You
                ...
                <li>
                    ...
                    <p>
                        ...
                        the Website, such as remembering your guess or theme preference. The purpose
                        of these Cookies is to provide You with a more personal experience and to
                        avoid You having to re-enter your guesses or preferences every time You use
                        the Website.
                    </p>
                </li>
            </ul>
            ...
            <ul class="list-disc list-inside">
                <li>
                    ...
                    <a
                        href="http://lolprodle.com/discord"
                        rel="external nofollow noopener"
                        target="_blank"
                        class="link"
                    >
                        http://lolprodle.com/discord
                    </a>
                </li>
            </ul>
        </div>
